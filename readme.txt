...
Manual installation:
<ol>
<li>Upload the folder `scancircle` to the `/wp-content/plugins/` directory</li>
<li>Activate the `scancircle` plugin through the 'Plugins' menu in WordPress</li>
<li>Place the [scancircle ...] shortcut in your posts</li>
</ol>
